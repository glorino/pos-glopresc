...
async function main() {
  ...
  const productsData = [
    // Food & Snacks
    { name: "Indomie Noodles (Pack of 10)", sku: "FD-001", price: 1500, costPrice: 1100, stockQuantity: 200, minStockLevel: 30, categoryId: categories["Food & Snacks"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "pack", image: "https://placehold.co/400x300/2d1f0e/f59e0b?text=Indomie+Noodles" },
    { name: "Indomie Noodles (Single)", sku: "FD-002", price: 200, costPrice: 150, stockQuantity: 500, minStockLevel: 50, categoryId: categories["Food & Snacks"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "piece", image: "https://placehold.co/400x300/2d1f0e/f59e0b?text=Indomie+Single" },
    { name: "Mama Gold Rice (50kg)", sku: "FD-003", price: 65000, costPrice: 55000, stockQuantity: 30, minStockLevel: 10, categoryId: categories["Food & Snacks"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "bag", image: "https://placehold.co/400x300/2d1f0e/f59e0b?text=Mama+Gold+Rice" },
    { name: "Topic Rice (25kg)", sku: "FD-004", price: 35000, costPrice: 28000, stockQuantity: 50, minStockLevel: 15, categoryId: categories["Food & Snacks"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "bag", image: "https://placehold.co/400x300/2d1f0e/f59e0b?text=Topic+Rice" },
    { name: "Knorr Chicken Cubes (Pack)", sku: "FD-005", price: 800, costPrice: 600, stockQuantity: 100, minStockLevel: 20, categoryId: categories["Food & Snacks"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "pack", image: "https://placehold.co/400x300/2d1f0e/f59e0b?text=Knorr+Cubes" },
    { name: "Peak Milk Powder (900g)", sku: "FD-006", price: 4500, costPrice: 3800, stockQuantity: 60, minStockLevel: 15, categoryId: categories["Food & Snacks"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "tin", image: "https://placehold.co/400x300/2d1f0e/f59e0b?text=Peak+Milk" },
    { name: "Bournvita (500g)", sku: "FD-007", price: 2500, costPrice: 2000, stockQuantity: 80, minStockLevel: 20, categoryId: categories["Food & Snacks"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "tin", image: "https://placehold.co/400x300/2d1f0e/f59e0b?text=Bournvita" },
    { name: "Golden Morn (500g)", sku: "FD-008", price: 1800, costPrice: 1400, stockQuantity: 70, minStockLevel: 15, categoryId: categories["Food & Snacks"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "pack", image: "https://placehold.co/400x300/2d1f0e/f59e0b?text=Golden+Morn" },

    // Beverages
    { name: "Pepsi (50cl)", sku: "BV-001", price: 300, costPrice: 200, stockQuantity: 300, minStockLevel: 50, categoryId: categories["Beverages"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "bottle", image: "https://placehold.co/400x300/0f1a2e/3b82f6?text=Pepsi" },
    { name: "Coca-Cola (50cl)", sku: "BV-002", price: 300, costPrice: 200, stockQuantity: 300, minStockLevel: 50, categoryId: categories["Beverages"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "bottle", image: "https://placehold.co/400x300/0f1a2e/3b82f6?text=Coca-Cola" },
    { name: "Fanta Orange (50cl)", sku: "BV-003", price: 300, costPrice: 200, stockQuantity: 250, minStockLevel: 50, categoryId: categories["Beverages"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "bottle", image: "https://placehold.co/400x300/0f1a2e/3b82f6?text=Fanta" },
    { name: " Eva Water (75cl)", sku: "BV-004", price: 300, costPrice: 180, stockQuantity: 400, minStockLevel: 80, categoryId: categories["Beverages"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "bottle", image: "https://placehold.co/400x300/0f1a2e/3b82f6?text=Eva+Water" },
    { name: "Monster Energy Drink", sku: "BV-005", price: 1500, costPrice: 1100, stockQuantity: 50, minStockLevel: 10, categoryId: categories["Beverages"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "can", image: "https://placehold.co/400x300/0f1a2e/3b82f6?text=Monster+Energy" },
    { name: "Star Beer (60cl)", sku: "BV-006", price: 500, costPrice: 350, stockQuantity: 200, minStockLevel: 40, categoryId: categories["Beverages"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "bottle", image: "https://placehold.co/400x300/0f1a2e/3b82f6?text=Star+Beer" },
    { name: "Gulder Lager (60cl)", sku: "BV-007", price: 500, costPrice: 350, stockQuantity: 180, minStockLevel: 40, categoryId: categories["Beverages"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "bottle", image: "https://placehold.co/400x300/0f1a2e/3b82f6?text=Gulder+Lager" },

    // Electronics
    { name: "Samsung Galaxy A14", sku: "EL-001", price: 120000, costPrice: 95000, stockQuantity: 25, minStockLevel: 5, categoryId: categories["Electronics"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/1a0f2e/8b5cf6?text=Samsung+A14" },
    { name: "iPhone 14 (128GB)", sku: "EL-002", price: 550000, costPrice: 480000, stockQuantity: 10, minStockLevel: 3, categoryId: categories["Electronics"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/1a0f2e/8b5cf6?text=iPhone+14" },
    { name: "Tecno Spark 10", sku: "EL-003", price: 85000, costPrice: 65000, stockQuantity: 30, minStockLevel: 8, categoryId: categories["Electronics"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/1a0f2e/8b5cf6?text=Tecno+Spark" },
    { name: "Infinix Hot 30", sku: "EL-004", price: 75000, costPrice: 58000, stockQuantity: 35, minStockLevel: 8, categoryId: categories["Electronics"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/1a0f2e/8b5cf6?text=Infinix+Hot+30" },
    { name: "Samsung Galaxy Buds", sku: "EL-005", price: 45000, costPrice: 35000, stockQuantity: 20, minStockLevel: 5, categoryId: categories["Electronics"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/1a0f2e/8b5cf6?text=Galaxy+Buds" },
    { name: "Apple AirPods Pro", sku: "EL-006", price: 180000, costPrice: 150000, stockQuantity: 15, minStockLevel: 3, categoryId: categories["Electronics"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/1a0f2e/8b5cf6?text=AirPods+Pro" },
    { name: "Anker Power Bank (20000mAh)", sku: "EL-007", price: 25000, costPrice: 18000, stockQuantity: 40, minStockLevel: 10, categoryId: categories["Electronics"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/1a0f2e/8b5cf6?text=Anker+Power+Bank" },
    { name: "Infinix XPad 10", sku: "EL-008", price: 135000, costPrice: 105000, stockQuantity: 12, minStockLevel: 3, categoryId: categories["Electronics"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/1a0f2e/8b5cf6?text=Infinix+XPad" },

    // Fashion
    { name: "Nike Air Max (Men)", sku: "FS-001", price: 85000, costPrice: 60000, stockQuantity: 20, minStockLevel: 5, categoryId: categories["Fashion"], supplierId: suppliers["Fashion Hub Nigeria"], unit: "pair", image: "https://placehold.co/400x300/2e0f1a/ec4899?text=Nike+Air+Max" },
    { name: "Adidas Superstar (Men)", sku: "FS-002", price: 75000, costPrice: 52000, stockQuantity: 18, minStockLevel: 5, categoryId: categories["Fashion"], supplierId: suppliers["Fashion Hub Nigeria"], unit: "pair", image: "https://placehold.co/400x300/2e0f1a/ec4899?text=Adidas+Superstar" },
    { name: "Gucci Belt", sku: "FS-003", price: 150000, costPrice: 110000, stockQuantity: 10, minStockLevel: 2, categoryId: categories["Fashion"], supplierId: suppliers["Fashion Hub Nigeria"], unit: "piece", image: "https://placehold.co/400x300/2e0f1a/ec4899?text=Gucci+Belt" },
    { name: "Levi's 501 Jeans", sku: "FS-004", price: 45000, costPrice: 30000, stockQuantity: 25, minStockLevel: 5, categoryId: categories["Fashion"], supplierId: suppliers["Fashion Hub Nigeria"], unit: "piece", image: "https://placehold.co/400x300/2e0f1a/ec4899?text=Levis+501+Jeans" },
    { name: "Polo T-Shirt (Men)", sku: "FS-005", price: 12000, costPrice: 7500, stockQuantity: 50, minStockLevel: 10, categoryId: categories["Fashion"], supplierId: suppliers["Fashion Hub Nigeria"], unit: "piece", image: "https://placehold.co/400x300/2e0f1a/ec4899?text=Polo+T-Shirt" },

    // Health & Beauty
    { name: "Nivea Body Lotion (400ml)", sku: "HB-001", price: 3500, costPrice: 2500, stockQuantity: 60, minStockLevel: 15, categoryId: categories["Health & Beauty"], supplierId: suppliers["Health Products Co"], unit: "bottle", image: "https://placehold.co/400x300/0f2e1a/10b981?text=Nivea+Lotion" },
    { name: "Dettol Antiseptic (500ml)", sku: "HB-002", price: 2800, costPrice: 2000, stockQuantity: 80, minStockLevel: 20, categoryId: categories["Health & Beauty"], supplierId: suppliers["Health Products Co"], unit: "bottle", image: "https://placehold.co/400x300/0f2e1a/10b981?text=Dettol" },
    { name: "Vitamin C Supplements (60 tabs)", sku: "HB-003", price: 5000, costPrice: 3500, stockQuantity: 40, minStockLevel: 10, categoryId: categories["Health & Beauty"], supplierId: suppliers["Health Products Co"], unit: "bottle", image: "https://placehold.co/400x300/0f2e1a/10b981?text=Vitamin+C" },
    { name: "Dove Shampoo (400ml)", sku: "HB-004", price: 4200, costPrice: 3000, stockQuantity: 50, minStockLevel: 12, categoryId: categories["Health & Beauty"], supplierId: suppliers["Health Products Co"], unit: "bottle", image: "https://placehold.co/400x300/0f2e1a/10b981?text=Dove+Shampoo" },
    { name: "Paracetamol (Tablets Pack)", sku: "HB-005", price: 800, costPrice: 500, stockQuantity: 150, minStockLevel: 30, categoryId: categories["Health & Beauty"], supplierId: suppliers["Health Products Co"], unit: "pack", image: "https://placehold.co/400x300/0f2e1a/10b981?text=Paracetamol" },

    // Home & Kitchen
    { name: "Prestige Pressure Cooker (5L)", sku: "HK-001", price: 35000, costPrice: 25000, stockQuantity: 15, minStockLevel: 3, categoryId: categories["Home & Kitchen"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "piece", image: "https://placehold.co/400x300/2e2a0f/f59e0b?text=Pressure+Cooker" },
    { name: "Binatone Blender", sku: "HK-002", price: 28000, costPrice: 20000, stockQuantity: 20, minStockLevel: 5, categoryId: categories["Home & Kitchen"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/2e2a0f/f59e0b?text=Binatone+Blender" },
    { name: "Nigerian Cast Iron Pot", sku: "HK-003", price: 15000, costPrice: 10000, stockQuantity: 25, minStockLevel: 5, categoryId: categories["Home & Kitchen"], supplierId: suppliers["Nigerian Food Suppliers"], unit: "piece", image: "https://placehold.co/400x300/2e2a0f/f59e0b?text=Cast+Iron+Pot" },
    { name: "Thermocool Refrigerator (Small)", sku: "HK-004", price: 180000, costPrice: 140000, stockQuantity: 8, minStockLevel: 2, categoryId: categories["Home & Kitchen"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/2e2a0f/f59e0b?text=Thermocool+Fridge" },
    { name: "Infinix Washing Machine (8kg)", sku: "HK-005", price: 220000, costPrice: 170000, stockQuantity: 6, minStockLevel: 2, categoryId: categories["Home & Kitchen"], supplierId: suppliers["Tech Distributors Ltd"], unit: "piece", image: "https://placehold.co/400x300/2e2a0f/f59e0b?text=Washing+Machine" },
  ];
